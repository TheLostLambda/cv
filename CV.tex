...
\ifoot{\textbf{REFERENCES}\\\footnotesize Dr. Stéphane Mesnage, Personal Tutor
  \& Lecturer in Microbiology <s.mesnage@sheffield.ac.uk>\\ Dr. Tuck Seng Wong,
...
\definecolor{link}{RGB}{50,90,170}
...
\subsection*{Development Officer \& Workshop Instructor
  (2020-2021)\\\textmd{\emph{Part of the Sheffield Bionics Society} – \url{https://bit.ly/3qs5xSf}}}
\noindent
...
\subsection*{Programming Mentor \& Workshop Instructor
  (2018-2021)\\\textmd{\emph{Volunteer Teaching at the University, Sheffield UK}}}
\noindent
...
\subsection*{\textbf{\texttt{FTC\_HTTP}}: Wireless FTC Robot Programming Tool
  (2017-2021)\\\textmd{\emph{Cross-platform CLI Application} – \url{http://bit.ly/ftc_http}}}
\noindent
...
\subsection*{Personal Web Server (2015-Current)\\\hspace{14.22636pt}\textmd{\emph{File-Sync, VPN,
...
\subsection*{Lost in Translation: Proteins Post-Expression
  (2019)\\\hspace{14.22636pt}\textmd{\emph{Scientific Poster on the
...
\tagged{short}{
\subsection*{Creepy Phenomena: An Investigation of Viscoelasticity
  (2019)\\\hspace{14.22636pt}\textmd{\emph{Mathematical Analysis of a Physical
...
\tagged{short}{
\subsection*{\textbf{\texttt{FTC\_HTTP}} Programming Tool (2017)\\\hspace{14.22636pt}\textmd{\emph{A Cross-Platform
